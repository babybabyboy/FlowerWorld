...
public class ContentMianActivity extends AppCompatActivity {
    /*
...
public class ContentMianActivity extends FragmentActivity implements View.OnClickListener, ViewPager.OnPageChangeListener,OnFragmentInteractionListener
{
